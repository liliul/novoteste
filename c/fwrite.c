...
int main()
{
    ...
    float pi = 3.1415;
    float pilido;
    if ((pf = fopen("/compiler/arquivo.bin", "wb")) == NULL) /* Abre arquivo bin�rio para escrita */
    {
    ...
    if ((pf = fopen("/compiler/arquivo.bin", "rb")) == NULL) /* Abre o arquivo novamente para leitura */
    {
        printf("Erro na abertura do arquivo");
        exit(1);
    }
